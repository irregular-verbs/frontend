...
export const h = (...args) => {
    ...
    if (typeof tag === "string") {
        if (tag.indexOf("$") != -1) {
            typeProps = typeProps || {}
            typeProps.key = tag.substring(tag.indexOf("$") + 1)
...
// div with attributes and vararg children
    h("div", {className: "header"},
        h("span", "Some"),
        h("span", "Text")
    )

// div without attributes and vararg children
    h("div",
        h("span", "Some"),
        h("span", "Text")
    )

// div with attributes and childrens as array
    h("div", {className: "header"}, [
        h("span", "Child 1", {key: "id4123"}),
        h("span", "Child 2", {key: "id4123"})
    ])

// div without attributes and childrens as array
    h("div", [
        h("span", {key: "id4123"}, "Child 1"),
        h("span", {key: "id4123"}, "Child 2")
    ])
